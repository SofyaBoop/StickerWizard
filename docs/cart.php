...
<header class="dropdown_navbar">
    ...
    <div class="modal_notice_exit__content modal_content">
        ...
        <dialog id="successful_order_cart" class="successful_order_cart modal_window" aria-label="Окно выхода">
    <div class="modal_successful_order_post__content modal_content">
        <h4>Поздравляем!</h4>
        <span class="window_text">
            <p>Ваш заказ принят!</p>
        </span>
        <button onclick="window.successful_order_cart.close();" aria-label="close" class="x_exit"><i class="fa-solid fa-xmark"></i></button>
    </div>
</dialog>
        <?php
